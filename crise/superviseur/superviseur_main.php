...
<div id="div2">
	...
	<fieldset id="field1">
		...
		<p>
			...
			Les éléments validés de la check-list sont automatiquement enregistrés dans la main courante.
		</p>
	</fieldset>
	...
	<fieldset id="field1">
		...
		<p>
			Sélectionner les hôpitaux qui doivent être contactés dans le cadre d'une recherche de lits
		</p>
	</fieldset>
	...
	<fieldset id="field1">
		...
		<p>
			Sélectionner les spécialités qui doivent être contactés dans le cadre d'une recherche de lits. Combiné avec l'item précédent permer de disposer d'une fiche de
			recueuil de lits et d'un tableau de synthèse hôpitaux/spécialités.
		</p>
	</fieldset>
