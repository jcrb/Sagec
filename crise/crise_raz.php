...
$titre_principal = "Crise - Réinitialisations";
...
if($_REQUEST['ok']=='Réinitialiser')
{
	...
	$message = "Main courante sauvegardée dans ".$sauvegarde;
...
<div id="div2">
	...
	<input type="submit" name="ok" id="valider" value="Réinitialiser" onclick="return confirm('Etes vous sûre de vouloir effacer la main courante ?\n(la main courante sera sauvegardée)');"/>
</div>
