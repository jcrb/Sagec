...
<body onload="document.getElementById('nom').focus()">
	...
	<div id="formtitle">Unités Fonctionelles - Mise à jour</div>
...
print("<legend> UF Id $rub[uf_ID]</legend>");
	...
	print("<p>");
		print("<label for=\"hopNom\" title=\"hopNom\">Hôpital :</label>");
		fhopital($rub['Hop_ID']);
	...
	print("<p>");
		print("<label for=\"ufActivite\" title=\"ufActivite\">Activité :</label>");
		fUfActivite($rub['uf_activite_ID']);
		print("<span class=\"exemple\">$rub[uf_activite_ID]</span>");
	print("</p>");

	print("<p>");
		print("<label for=\"ufSpecialite\" title=\"ufSpecialite\">Spécialité :</label>");
		fUfSpecialite($rub['uf_specialite_ID']);
		print("<span class=\"exemple\">$rub[uf_specialite_ID]</span>");
	print("</p>");
	
	print("<p>");
		print("<label for=\"ufsurSpecialite\" title=\"ufsurSpecialite\">sur Spécialité :</label>");
