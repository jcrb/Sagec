...
/**
*	Liste les UF d'un hôpital
* 	@param [in] $hopid identifiant sagec de l'hôpital
*/
function get_UF_hopital($hopid)
{
	...
	print("<table>");
		print("<tr>");
			...
			print("<td>Pole ID</td>");
			print("<td>Hôpital ID</td>");
			print("<td>Hôpital nom</td>");
...
/**
* statistiques
* affiche les données lits de l'UF 
...
* s'il existe plusieurs UF, les résultats sont groupés
...
function veilleSAU($orgid)
{
	...
	print($rub['org_nom']."<br>Activité des services d'urgence<br><br>");
...
/**
* 	récupère les enregistrements les plus récents pour chaque UF
*	Les enregistrements sont regroupés par UF. Dans chaque groupe, l'enregistrement
*	dont la date est la plus récente est retourné
*	En pratique on obtient pour chaque UF, la date de la dernière mise à jour
*	@todo limiter la recherche à un hopital ou une structure
*/
...
/**
pour corriger une erreur initiale dans la base de donnée
* NE PLUS L'UTILISER
*/
/*
...
$hopid = 6; // hôpital de Haguenau 
$ufid = 425; // réanimation Haguenau
