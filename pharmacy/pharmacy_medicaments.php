...
/**----------------------------------------- SAGEC ---------------------------------
  ...
  */	
/** ---------------------------------------------------------------------------------
  * programme: 			pharmacy_medicaments.php
...
$backPathToRoot = "../";
$titre_principal = "Pharmacie - Médicaments";
$sousmenu = "";
...
<div id="div2">
	...
	<fieldset id="field1">
		<legend><? echo 'Ajouter un médicament';?> </legend>
		<p><a href="medicament_fiche.php">Nouveau</a></p>
	</fieldset>
	
	<fieldset id="field1">
		<legend><? echo 'Liste des médicaments';?> </legend>
			<?php liste_med($connexion,1,$_REQUEST[tri],$_REQUEST[ordre]);?>
