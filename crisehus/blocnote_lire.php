...
$backPathToRoot = "../";
$titre_principal = "Direction Générale - Main courante";
...
<table>
	<tr>
		<td><a href="blocnote_lire.php"><?php echo $string_lang['LIREBN'][$langue];?></a></td>
		<td><a href="bloc_note.php"><b>Nouveau Message</b></a></td>
		<?php
...
<?php
	...
	while($i = LigneSuivante($result))
	{
		...
		TblCellule("$i->nom");
		?>
		<td><div align="left"><?php echo Security::db2str($i->LBS_Message);?></div></td>
		<?php
