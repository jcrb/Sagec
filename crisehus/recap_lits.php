...
function affiche_resultat($hopital, $hop_nom)
{
	...
	print("<table>");
		...
		print("<tr>");
			...
			print("<th>lits libérables</th>");
			print("<th>lits installés</th>");
		print("</tr>");
...
print("<table width=\"100%\">");
	print("<tr>");
		print("<td>");
			affiche_resultat("'2'", "Hôpital Civil");
		print("</td>");
		print("<td>");
			affiche_resultat("'1'", "Hôpital de Hautepierre");
		print("</td>");
	print("</tr>");
	print("<tr>");
		print("<td>");
		...
		print("</td>");
		print("<td>");
			affiche_resultat("'1','2','3'", "Totalité des lits");
		print("</td>");	
	print("</tr>");
print("</table>");
