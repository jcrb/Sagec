...
* @version $Id: map_data.php 43 2008-03-13 22:41:12Z jcb $
* @author jcb
*/
   ...
   var bou_ico = new GIcon(baseIcon, "Police32.png", null, "");
   
	
	var cRight = new GCopyrightCollection('Sagec67');
	var copyright = new GCopyright(1, new GLatLngBounds(new GLatLng(-90, -180), new GLatLng(90, 180)), 0, "Sagec67Â©2006");
...
function prm(dessine)
{
	...
	// point de rassemblement des moyens
			...
			prmMarker = addAMarker(prmPoint,prm_ico);
	}
	if(dessine)
	{
