...
//----------------------------------------- SAGEC --------------------------------
//
//	programme: 		ajoute_fichier.php
//	date de création: 	06/02/2005
//	auteur:			jcb
//	description:		ajoute un fichier dans un dossier
//	version:			1.0
//	maj le:			06/02/2005
//
//--------------------------------------------------------------------------------
...
//================================================================================
print("<BODY>");
print("<FORM name=\"menu\" method=\"post\" enctype=\"multipart/form-data\" action=\"ajoute_f_execute.php\">");

print("Transférer un fichier dans SAGEC<br><br>");
print("<table>");
...
print("</tr>");
print("<tr>");
	print("<td>dossier de destination</td>");
	print("<td><input type=\"text\" lang=\"fr\" name=\"dossier\" size=\"50\" value=\"../\"></td>");
print("</tr>");
print("<table>");
print("</BODY>");
?>
