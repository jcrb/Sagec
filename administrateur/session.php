...
//	date de création: 	02/07/2005
///	auteur:			jcb
//	description:		affiche les données du tableau SESSION
//	version:			1.0
//	maj le:			02/07/2005
//
//---------------------------------------------------------------------------------------------------------
...
if($utilisateur)
{
	print("<table>");
		...
		print("</tr>");
		print("<tr>");
			print("<td>Modification hôpital</td>");
			print("<td>".$_SESSION["modif_hopital"]."</td>");
		print("</tr>");
		print("<tr>");
			print("<td>Serveur utilisé</td>");
			print("<td>".gethostbyaddr($_SERVER['SERVER_ADDR'])."</td>");
		print("</tr>");
	print("</table>");
}
?>
