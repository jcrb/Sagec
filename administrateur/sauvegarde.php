...
print("<TR>");
	print("<TD>Evènement courant</TD>");fwrite($fp,"Evènement courant: ");
	...
	print("<TD> à $rub[evenement_heure1]</TD>");fwrite($fp,", à ".$rub[evenement_heure1]."\n");
print("</TR>");
print("</table><br>");

print("<table width=\"100%\" border=\"1\" cellspacing=\"0\" cellpadding=\"5\" class=\"Style22\">");
print("<TR>");
	print("<TD>Plans déclenchés</TD>");fwrite($fp,"Plans déclenchés: ");
	print("<TD>");
		print("<table width=\"100%\" border=\"1\" cellspacing=\"0\" cellpadding=\"5\" class=\"Style22\">");
		print("<TR>");
			print("<TD>Plan</TD>");
		...
		while($rub=mysql_fetch_array($resultat))
		{
			...
			print("<TD>".usdate2fdate($rub['date1'])."</TD>");fwrite($fp,"déclenché le :".$rub[date1]." ");
			print("<TD>".usdate2fdate($rub['date2'])."</TD>");fwrite($fp,"levé le :".$rub[date2]."\n");
			print("</TR>");
		}
		print("</table>");
	print("</TD>");
...
print("<br>Personnels engagés (SAMU 67)<br>");
print("<table width=\"100%\" border=\"1\" cellspacing=\"0\" cellpadding=\"5\" class=\"Style22\">");
...
print("<fieldset>");
print("<legend><font face=\"arial\" size=\"2\">Répartition des victimes dans les hôpitaux</font></legend>");
