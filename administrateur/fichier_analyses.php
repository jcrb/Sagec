...
while(!feof($fp))
{
	...
	/*
	if(($moyen=="Ambulance catégorie A") || ($moyen=="Ambulance de garde") || $moyen==("Ambulance privee"))
		$requete = "UPDATE veille_samu SET nb_apa= nb_apa + '$n' WHERE date='$date'";

	else if(($moyen=="Conseil médical")||($moyen=="Renseign.médical"))
		$requete = "UPDATE veille_samu SET conseils= conseils + '$n' WHERE date='$date'";

	else if(($moyen=="Garde hors secteur")||($moyen=="Maison médicale de l'Asum")||($moyen=="Medecin")||($moyen=="SOS Médecins"))
