...
//================================== partie administration hospitalière ========================================
...
//--------------------------------------------- Lésions 2 ---------------------------------------------------
print("<fieldset>");
print("<legend>Lésions traumatiques</legend>");
...
print("</TR>");
print("<TR>");
	print("<TD>cou antérieur</TD>");
	for($i=0;$i<$n;$i++)
		print("<TD><div align=\"center\"><input type=\"checkbox\" name=\"t[][$i]\"></div></TD>");
print("</TR>");
print("<TR>");
	print("<TD>cou postérieur</TD>");
	for($i=0;$i<$n;$i++)
		print("<TD><div align=\"center\"><input type=\"checkbox\" name=\"t[][$i]\"></div></TD>");
print("</TR>");
print("<TR>");
...
print("<TR>");
	print("<TD>épaule droite</TD>");
	for($i=0;$i<$n;$i++)
		print("<TD><div align=\"center\"><input type=\"checkbox\" name=\"t[][$i]\"></div></TD>");
print("</TR>");
print("<TR>");
	print("<TD>épaule gauche</TD>");
	for($i=0;$i<$n;$i++)
		print("<TD><div align=\"center\"><input type=\"checkbox\" name=\"t[][$i]\"></div></TD>");
print("</TR>");
print("<TR>");
