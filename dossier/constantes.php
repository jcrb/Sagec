...
print("<TR>");
	...
	print("<TD>dossier <input type=\"text\" name=\"dossier\" size=\"10\" value=$_REQUEST[dossier]></TD>");
...
//--------------------------------------------- Autres -----------------------------------------------------
print("<fieldset class=\"time3\">");
print("<legend> Autres </legend>");
print("<table bgcolor=\"#ccccff\" width=\"75%\" border=\"1\" cellspacing=\"0\" cellpadding=\"5\" class=\"Style22\">");
print("<TR>");
	print("<TD>Glycémie <input type=\"text\" name=\"gly\" size=\"2\" value=\"1\"> g/L</TD>");
	print("<TD>Température <input type=\"text\" name=\"temp\" size=\"2\" value=\"37\"> °C</TD>");
	print("<TD>Diurèse <input type=\"text\" name=\"diurese\" size=\"2\" value=\"0\"> ml</TD>");
print("</TR>");
print("</table>");
print("</fieldset>");
?>
