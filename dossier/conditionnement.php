...
print("<TR>");
	...
	print("<TD><input type=\"checkbox\" name=\"scope\"> Oxymètre</TD>");
...
print("<TR>");
	...
	print("<TD><input type=\"checkbox\" name=\"allongé\"> Allongé</TD>");
...
//--------------------------------------------- Réa cardio -----------------------------------------------------
print("<fieldset>");
print("<legend>Réanimation cardiaque</legend>");
print("<table bgcolor=\"#ccccff\" width=\"100%\" border=\"1\" cellspacing=\"0\" cellpadding=\"0\" class=\"Style22\">");
print("<TR>");
	...
	print("</TR><TR>");
	print("<TD><input type=\"checkbox\" name=\"attelle\"> Entrainement électro-systolique externe</TD>");
	...
	print("<TD><input type=\"checkbox\" name=\"pm\"> Planche à masser</TD>");
...
print("<TR>");
	...
	print("<TD> opérateur <input type=\"text\" name=\"op11\" size=\"20\" value=\"\"></TD>");
	print("</TR><TR>");
	print("<TD><input type=\"checkbox\" name=\"sun\"> Sonde urinaire</TD>");
	print("<TD> opérateur <input type=\"text\" name=\"op2\" size=\"20\" value=\"\"></TD>");
	print("</TR><TR>");
	print("<TD><input type=\"checkbox\" name=\"drainTho\"> Drain thoracique</TD>");
	print("<TD> opérateur <input type=\"text\" name=\"op3\" size=\"20\" value=\"\"></TD>");
print("</TR>");
print("</table>");
print("</fieldset>");
?>
