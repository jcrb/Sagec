...
$back = $backPathToRoot.$_REQUEST['back'];

print("<HTML><HEAD><TITLE>Sauvegarde</TITLE>");
print("<LINK REL=stylesheet HREF=\"../pma.css\" TYPE =\"text/css\"></HEAD>");

$a = "<a href=\"$back\" target=\"_parent\">retour</a>";
$b = "<a href=\"\">test 2</a>";
$c = "<a href=\"\">test 3</a>";
$menu= $a." | ".$b." | ".$c;
entete_sagec2("Dossier médical","center",$menu,$backPathToRoot);
?>
