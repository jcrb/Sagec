...
//======================================  Retour  ===============================================
if($_POST['ok'])	// enregistrement du nouvel évènement
{
	...
	if($rub['evenement_nom']!=$_POST['titre'])//si l'évènement précédant a un nom différent
	{
	...
	if($_POST['titre'] != "Aucun évènement en cours")
	{
