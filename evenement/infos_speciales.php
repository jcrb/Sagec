...
//	auteur:							jcb
//	description:				informations spécifiques sur la crise
//	version:						1.2
//	maj le:							18/12/2005
//
//--------------------------------------------------------------------------------
...
print("<TR>");
	...
	print("<TD><input type=\"text\" name=\"titre\" value=\"".Security::db2str($rub[evenement_nom])."\" size=\"30\"></TD>");
print("</TR>");
print("<TR>");
...
print("</TR>");
print("<TR>");
	print("<TD>Direction du vent (degré)</TD>");
