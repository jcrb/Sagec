...
$d = "<a href=\"../services/service_bloc_note_efface.php\" target=\"middle\">Effacer le bloc-note</a>";
$e = "<a href=\"../services/service_bloc_note.php\" target=\"middle\">Message groupe ARH</a>";

$menu= $a.' | '.$b.' | '.$c.' | ';
if($_SESSION['autorisation']>8) $menu.= $d.' | ';
$menu.= $e;
