<?
  ...
  /* méthode d'appel
  print("<form name=\"tab_gard\">");
  print("<input TYPE=\"text\" VALUE=\"\" NAME=\"date\" SIZE = \"10\"><input type='button' value='...' onClick=\"window.open('../mycalendar.php?form=tab_gard&elem=date','Calendrier','width=200,height=220')\">");
  print("</form>");
  */
...
print($date);
  echo "\n<tr><td colspan='10' align='center'><input type='button' onclick='window.opener.document.forms[\"$_GET[form]\"].elements[\"$_GET[elem]\"].value=\"$date\";window.close()' value='Valider'>&nbsp;&nbsp;<input onclick='window.close()' type='button' value='Annuler'></td></tr></table>\n" ;
