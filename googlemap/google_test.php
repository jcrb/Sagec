...
<body <?php echo("onload='load($longitude,$latitude,$altitude)'")?> onunload="GUnload()">
	...
	<div id="toolbar">
		<table border="1" width="100%">
			<tr><td><a href="<?php echo($back) ?>">Page précédante</a></td></tr>
			<tr><td><input type="checkbox" name="pharmacie" id="pharma" onclick="analyseMenu();"> Pharmacies</td></tr>
			<tr><td><input type="checkbox" name="pma_noel" id="pma" onclick="analyseMenu();"> PMA marché de noël</td></tr>
			<tr><td><a href="./../ppi/ppi_reichstett/carto_main.php"><b>PPI Reichstett (démo)</b></a></td></tr>
		</table>
	</div>
</body>
</html>