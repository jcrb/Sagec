...
function liste_materiel($connexion,$item_select="")
{
	...
	print("<select name=\"type_materiels\" size=\"1\" onChange='$onChange'>");
...
function liste_ville($connexion,$item_select="")
{
	$requete="SELECT ville.ville_ID,ville.ville_nom
					...
					ORDER BY ville_nom";
	$resultat = ExecRequete($requete,$connexion);
	print("<select name=\"type_ville\" size=\"1\" onChange='$onChange'>");
...
function liste_acheteur($connexion,$item_select="")
{
	...
	$resultat = ExecRequete($requete,$connexion);
	print("<select name=\"type_acheteur\" size=\"1\" onChange='$onChange'>");
	print("<OPTION VALUE = \"0\">Tous</OPTION> \n");
	while($rub=mysql_fetch_array($resultat))
	{
...
function liste_fournisseurs($connexion,$item_select="")
{
	...
	$resultat = ExecRequete($requete,$connexion);
	print("<select name=\"type_fournisseur\" size=\"1\" onChange='$onChange'>");
	print("<OPTION VALUE = \"0\">Tous</OPTION> \n");
	while($rub=mysql_fetch_array($resultat))
	{
