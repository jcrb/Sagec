...
<?php
$requete = "SELECT * FROM tache_cod WHERE tache_fonction = '$fonction' ORDER BY tache_priorite";
...
<table>
	...
	<tr>
		...
		<td  id="tdLeft" bgcolor="#CCFF99">
			<input type="checkbox" id="<?php echo $rep['tache_ID'];?>"
			name="cb"
			onClick="ischeck(<?php echo $rep[tache_ID];?>)"
			value="<?php echo $rep['tache_ID'];?>"
			<?php if($rep['tache_faite']=='o') print("checked");?>
		</td>
		<?php
