...
//----------------------------------------- SAGEC ---------------------------------------------//
//
//	programme: 		acheteur_nouveau.php
...
//====================== Corps =======================================
print("<BODY>");
print("<FORM NAME=\"\" ACTION=\"acheteur_enregistre.php\" METHOD=\"GET\">");
print("<input type=\"hidden\" name=\"back\" value=\"$_GET[back]\">");
entete_sagec("Acheteur");
...
//liste_acheteur($connexion,$item_select,$langue,$change="");
