...
//----------------------------------------- SAGEC ---------------------------------------------//
//
//	programme: 		materiel_nouveau.php
...
//======================= En T?te ====================================
print("<HTML><HEAD>");
print("<TITLE>materiel</TITLE>");
print("<LINK REL=stylesheet HREF=\"./../pma.css\" TYPE =\"text/css\">");
print("</HEAD>");
//====================== Corps =======================================
print("<BODY>");
print("<FORM NAME=\"\" ACTION=\"materiel_enregistre\" METHOD=\"GET\">");
print("<input type=\"hidden\" name=\"back\" value=\"$_GET[back]\">");
entete_sagec("Materiel");
...
//liste_materiel($connexion,$item_select,$langue,$change="");
