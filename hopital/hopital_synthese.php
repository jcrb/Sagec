<?php
/**
*	hopital_synthese.php
*	tableau croisant hôpitaux et lits
*/
session_start();
...
$liste_typeID = "1','2','4','5','6','7','8','10','21','22";// liste des spécilités à afficher (voir table type_service)
...
<LINK REL ="stylesheet" TYPE ="text/css" HREF ="hopital.css">
</head>
<body>
<form name="tableau croisé" action="hopital_synthese" method="post">
<div id="">
	<table>
		<tr>
			...
			<td><input type="submit" name="maj" value="mise à jour"</td>
		</tr>
	</table>
</div>

<div id = "tableau">
<table border cellspacing="0" bgcolor="#EEEEEE">
	<!-- EN TETE DE LA TABLE -->
	<tr bgcolor="#9999FF">
		<td>&nbsp;</td>
...
<?php
/**
*	Sélectionne les hôpitaux d'intérêt
*	la liste est limitée aux hôpitaux Allemands ($zone = 100)
...
while($rep=mysql_fetch_array($resultat))
{
	...
	?>
	<tr bgcolor="#DDDDD">
		<td><a href="hop_saisie.php?hopID=<?php echo $rep[Hop_ID] ?>"><?php echo $nb_hop; ?></a></td>
