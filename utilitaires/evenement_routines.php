...
/**
  *		select_generique()
  *		@ $table	table a  lister
  *		@ $order	colonne de tri
  *		@ $name		nom de la variable retournee
  *		@ $col		nom de la colonne a  afficher
  *		@ $val		nom de la colonne des valeurs associees aux items
  *		@ $select	nom de la veleur affichee par defaut
  */
...
function select_generique($table,$order,$name,$col,$select)
{
	...
	{
		print("<OPTION VALUE=\"$rub[$order]\" ");
		if($select == $rub[$order]) print(" SELECTED");
...
/** ============================================================================
SelectGroupe()Cree une liste deroulante avec la liste des groupes de discipline
			$connexion 		variable de connexion
			$item_select	fonction_ID de l'organisme selectionne
