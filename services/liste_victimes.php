...
//	date de création: 	5/03/2005
//	auteur:			jcb
//	description:		affiche la liste des victimes adressées à un service
//	version:		1.0
...
while($rub=mysql_fetch_array($resultat))
{
	...
	print("<tr>");
		...
		print("<td>&nbsp;</td>");
		//print("<td><a href=\"dossier/dossier_frameset.php?id=$rub[no_ordre]&back=$back\">accéder au dossier médical</a></td>");
		print("<td>");
			print("<a href='../dossier/dossier_frameset.php?id=$rub[no_ordre]&back=$back'>accéder au dossier médical </a>");
		print("</td>");
	print("</tr>");
	print("</table>");
	print("</p>");
