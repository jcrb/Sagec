...
$a = "<a href=\"passages_sau.php?service=$service\">nouveau</a>";
$b = "<a href=\"passage_sau_liste.php?service=$service\">liste</a>";
$c = "<a href=\"\">statistiques</a>";
$d = "<a href=\"\">glossaire</a>";
$menu= $a." | ".$b." | ".$c." | ".$d;
