...
print("<div>");
print("<frameset>");
$french= "Toutes les personnes travaillant dans le même hôpital, peuvent partager ce bloc-note. Il permet notamment l'échange d'informations entre la direction et les services. Si la case 'SAMU' est cochée, une copie du message apparaîtra dans le bloc-note du SAMU.";
...
$german = "Alle Personen, die im selben Krankenhaus arbeiten, können diesen Block-Vermerk teilen. Er erlaubt insbesondere den Informationsaustausch zwischen der Direktion und den Diensten. Wenn der Kasten 'SAMU' angekreuzt wird, wird eine Kopie der Mitteilung im Block-Vermerk des SAMU erscheinen.";
