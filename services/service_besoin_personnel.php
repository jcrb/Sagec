...
//----------------------------------------- SAGEC ---------------------------------------------//
//												//
//	programme: 		service_besoin_personnel.php						//
...
print("Objectif: recenser les besoins en personnels pour renforcer les équipes et assurer un fonctionnement optimal du service en cas de catastrophe.");
print("<br>");
print("<br>");
...
print("Ziel(Objektiv): die verfügbaren Personalien aufzählen, um andere Mannschaften im Falle der Katastrophe zu verstärken.");
