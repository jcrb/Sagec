...
$mot="Etat des fermetures de lits par spécialités";
print("<H3>$mot</H3>");
print("<TABLE WIDTH=\"100%\" CLASS=\"Style22\">");
print("<tr>");
	print("<td>Sélectionner une spécialité</td>");
	print("<td>");
	...
	print("<td>début <input type=\"text\" name=\"debut\" value=\"$debut\" size=\"10\"></td>");
...
print("<tr>");
	...
	print("<th>ratio lits fermés/lits autorisés</th>");
...
print("<tr>");
	print("<td>TOTAL</td>");
	print("<td>Lits fermés ".$tot_fermes."</td>");
	print("<td>Lits autorisés ".$tot_autorises."</td>");
	if($tot_autorises != 0)
