...
//----------------------------------------- SAGEC --------------------------------
//
//	programme: 		cle_supprime.php
//	date de création: 	15/05/2005
//	auteur:			jcb
//	description:		supprime une clé de cryptage
//	version:			1.0
//	maj le:			15/05/2005
//
//--------------------------------------------------------------------------------
...
if($_GET['cle'])
{
	...
	if (is_array($Keys)) {
		...
		for($i=0;$i<count($Keys);$i++){
			print("<tr>");
			$cle = $Keys[$i]['KeyID'];
			print("<td><A href=\"cle_supprime.php?cle=$cle\">supprimer</A></TD>");
