...
//	auteur:			jcb									//
//	description:		affiche les caractéristiques d'une ville dont l'identifiant est 	//
...
print("<html>");
print("<head>");
print("<title>caractéristiques villes </title>");
print("<LINK REL=stylesheet HREF=\"./../../pma.css\" TYPE =\"text/css\">");
?>
<script>
	function alerte()
	{
		if(confirm("Voulez-vous vraiment supprimer définitivement cette ville ?"))
		{
			window.close();
		}
	}
...
print("</TR>");
print("<TR>");
	print("<TD class=\"blue\">département</TD>");
...
print("</TR>");
print("<TR>");
	print("<TD class=\"blue\">Territoire de santé</TD>");
	print("<TD>");
		select_territoire_sante($connexion,$rub['territoire_sante'],$langue,"");// retourne $id_territoire
	print("</TD>");
		print("<TD class=\"blue\">Territoire de proximité</TD>");
	print("<TD>");
