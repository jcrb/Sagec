...
function Sau(dessine)
{
	if(sau.length < 1)
	{
		...
		<?php
				// sélectionne hôpital à partir de la table hopital 
    			$requete = "SELECT ad_longitude, ad_latitude,Hop_nom
    							FROM hopital, adresse WHERE Hop_SAU = 'o'
    							AND hopital.adresse_ID = adresse.ad_ID
    							";
    			// sélectionne hôpital à partir de la table service
    			// => pour que l'hopital soit sélectionné, il faut que le service existe		
    		...
    		var texte="test";
			// prend en compte les hôpitaux où il existe plusieurs SAU
			var hop_courant = '';
			var contact ='';
