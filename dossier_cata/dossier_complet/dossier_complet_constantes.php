...
/**----------------------------------------- SAGEC ---------------------------------
  ...
  */	
/** ---------------------------------------------------------------------------------
  * programme: 			dossier_complet_constantes.php
...
$titre_principal = "Dossier ".$id." - Constantes";
...
$requete = "SELECT * FROM dm_constantes2 WHERE victime_ID = '$id'";
...
<?php while($rep=mysql_fetch_array($resultat)){
		echo $rep[victime_ID].' '.$rep[date].' '.$rep[exam_ID].' '.$rep[resultat].'<br>';
		}
?>
