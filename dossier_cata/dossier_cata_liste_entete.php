...
/**----------------------------------------- SAGEC ---------------------------------
  ...
  */	
/** ---------------------------------------------------------------------------------
  * programme: 			dossier_cata_liste.php
...
//include_once("dossier_cata_liste.php");
...
require($backPathToRoot."dossier_cata/cata_menu_top.php");
require($backPathToRoot."dossier_cata/liste_victime.php");
