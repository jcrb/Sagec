...
$titre_principal = $_SESSION['PMA']."&nbsp;<a href=\"dossier_cata_saisie.php?nom=$identifiant&ecran=G\">(version grand écran)</a>";
...
<div>
	...
	<!-- Colonne de droite -->
	<!-- -->
	 <!-- ATTENTION les champs flottants doivent être mis en premier
