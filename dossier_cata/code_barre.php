...
class debora
{
    ...
    * return            void
    */
    function debora($EAN13,$hauteur=70,$largeur=120)
    {
    ...
    */
    function makeImage($imageType="png")
    {
        ...
        $img=imagecreate($this->larg, $this->haut);
        $color[0] = ImageColorAllocate($img, 255,255,255);
        $color[1] = ImageColorAllocate($img, 0,0,0);
        $coords[0] = 15;
        $coords[1] = 10;
        $coords[2] = 1;
        $coords[3] = $this->haut/2; //40
        imagefilledrectangle($img, 0, 0, 95, $this->haut, $color[0]);//80
        ...
        $h = $this->haut/2 + 10;//50
        imagestring($img, 3, 7, $h, $this->EAN13[0], $color[1]);
        imagestring($img, 3, 19, $h, implode('', array_slice($this->EAN13,1, 6)), $color[1]);
        imagestring($img, 3, 65, $h, implode('', array_slice($this->EAN13,7)), $color[1]);
	ImagePNG($img,"cb.png");
