...
<?php
	$requete = "SELECT Hop_nom,Hop_ID,Hop_finess,ville_nom,ad_zone1,departement_ID,ville_lambertX,ville_lambertY
	...
	<div id = "">
		...
		<tboby>
			...
			<tr>
				...
				<td><?php echo $rub['ville_lambertX'];?></td>
				<td><?php echo $rub['ville_lambertY'];?></td>
