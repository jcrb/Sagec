...
/**----------------------------------------- SAGEC ---------------------------------
  ...
  */	
/** ---------------------------------------------------------------------------------
  * programme: 			new_materiel_biotox.php
...
<form name="" action= "new_materiel_enregistre.php?id=<?php echo $ID;?>" method = "post">
<div id="div2">
	<!-- champ de type INPUT -->
	<fieldset id="field1">
		...
		<p>
			...
			<input type="text" name="nom" id="nom" title="nom" value="<? echo Security::db2str($rub['materiel_nom']);?>" size="50" required onFocus="_select('nom');" onBlur="deselect('nom');"/>
		</p>
