...
require_once($backPathToRoot."biotox_utilitaires.php");
?>
...
<body onload="">
<form NAME="xx"  action="biotox_image.php?">
	<p>Choisir un matériel <?php echo liste_materiel($connexion);?> et <input type="submit" name="OK" value="Valider"></p>
