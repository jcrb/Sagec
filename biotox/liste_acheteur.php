...
$backPathToRoot = "../";
$titre_principal = "Biotox-Acheteurs";
$sousmenu = "";
...
<?php
	$requete = "SELECT * FROM acheteur";
	$reponse = ExecRequete($requete,$connexion);
?>
	<?php if(est_autorise("BIOTOX_ECRIRE")){?>
		<p><a href="acheteur_voir?id=0">NOUVEL ACHETEUR</a></p>
	<?php } ?>
	...
	<div id = "">
		...
		<tboby>
			...
			<tr>
				<td><?php echo $rub['acheteur_ID'];?></td>
				<td><?php echo Security::db2str($rub['acheteur_nom']);?></td>
				<td><?php echo $rub[''];?></td>
				<?php if(est_autorise("BIOTOX_ECRIRE")){?>
					<td><a href="acheteur_voir?id=<?php echo $rub['acheteur_ID'];?>">voir</a></td>
				<?php } ?>
			</tr>
			<?php } ?>
		</tboby>
