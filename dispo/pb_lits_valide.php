...
<body onload="document.getElementById('mat').focus()">
	...
	<fieldset id="field1">
		...
		<p>
			<label for="mat" title="Lits inoccupés">immédiatement:</label>
	...
	<fieldset id="field1">
		...
		<p>
			<label for="cadre" title="cadre">Cadres de santé:</label>
		...
		<p>
			<label for="med" title="med">Médecins/internes:</label>
