...
//require $backPathToRoot.'calendrier/mycalendar.php';
?>
...
<div id="div2">
	...
	<fieldset id="field1">
		...
		<p>
			...
			<input type="text" name="nomc" id="nomc" title="nomc" value="<? echo $organisme->org_nom_complet;?>" size="50" onFocus="_select('nomc');" onBlur="deselect('nomc');"/>
		</p>
	</fieldset>
