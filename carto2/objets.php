...
/** ---------------------------------------------------------------------------------
  ...
  * auteur:					jcb
  * description:			choisir un objet à représenter
  *								 
  * version:				1.0
  * maj le:			
  * -------------------------------------------------------------------------------*/
...
print("<legend>objets à représenter</legend>");
	...
	print("<OPTION VALUE = \"polyT\">Polytraumatisés</OPTION>");
	print("<OPTION VALUE = \"helico\">Hélicoptères</OPTION>");
	print("<OPTION VALUE = \"rea_adulte\">Réanimations Adultes</OPTION>");
	print("<OPTION VALUE = \"rea_ped\">Réanimations pédiatriques</OPTION>");
	print("<OPTION VALUE = \"morgue\">Morgues</OPTION>");
	print("</select>\n");
print("</fieldset>");

print("<fieldset class=\"time_v\">");
print("<legend>Choisir les départements</legend>");
$requete="SELECT * 
...
<input type="button" name="decoche" value="Tout décocher" onclick="checkBoxes(this.form,false)">

<legend>
	<input type ="checkbox" name="isocercle" checked > Isocercles centrés sur 
