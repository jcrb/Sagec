...
?>
<ul id=menu>
	<li><a href="med_new_dispo.php" target="middle"><?php echo('Nouvelle disponibilité');?></a>
	<li><a href="med_liste_dispo.php" target="middle"><?php echo('Lire / modifier les disponibilités');?></a>
	<li><a href="med_territoire.php" target="middle"><?php echo('Définir mon territoire');?></a>
	...
	<li><a href="med_carto_generale.php" target="middle"><?php echo('Cartographie générale');?></a>
	<li><a href="agenda.php" target="middle"><?php echo('Agenda');?></a>
	
	<li><a href="liste_medecins.php" target="middle"><?php echo('Liste médecins');?></a>
