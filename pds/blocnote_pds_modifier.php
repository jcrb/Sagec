...
if ($thisAction=="Enregistrer la modification")
{
    ...
    $sqlUpdate = "UPDATE livrebord_pds SET LB_ID = '$thisLB_ID' , org_ID = '$thisOrg_ID' , LB_Expediteur = '$thisLB_Expediteur' , LB_Date = '$thisLB_Date' , LB_Message = '$thisLB_Message'  WHERE LB_ID = '$thisLB_ID'";
...
elseif ($thisAction=="Supprimer")
{
    ...
    $sqlDelete = "DELETE FROM livrebord_pds WHERE LB_ID = '$thisLB_ID'";
    $resultDelete = MYSQL_QUERY($sqlDelete);

    echo "<b>Record with Id ".$thisLB_IDFromForm." a été détruit<br></b>";
    $thisLB_IDFromForm = "";
	//header("Location: blocnote_pds_lire.php");
}
...
?>
<?php
$sql = "SELECT   * FROM livrebord_pds WHERE LB_ID = '$thisLB_ID'";
...
<form name="livrebordUpdateForm" method="POST" action="blocnote_pds_modifier.php">
...
<a href="blocnote_pds_lire.php"> Retour au livre de bord"</a>
