...
/**													
*	programme 			blocnote_pds.php
*	@date de création: 	05/11/2006
*	@author:			jcb
*	description:		Restitue les information du bloc note spécifique de la PDS
*	@version:			1.0 - $ $
*	maj le:				05/11/2006
*	@package			Sagec
*/													
...
if($utilisateur)
{
	...
	print("<FORM name =\"blocnote\" METHOD=\"GET\" ACTION=\"blocnote_pds_enregistre.php\">");
	...
	TblDebutLigne("A1");
		...
		TblCellule("<A HREF=\"blocnote_pds_lire.php\">Annuler</A>");
	TblFinLigne();
	TblFin();
