...
//																
/**													
*	programme 			blocnote_pds_enregistre.php
...
{
	$monTexte = addslashes($_GET['montexte']);
	$connexion = Connexion(NOM,PASSE,BASE,SERVEUR);
	$query = "INSERT INTO livrebord_pds
	 		VALUES('','$_SESSION[organisation]','$_GET[auteur]','$_GET[date]','$monTexte')";
