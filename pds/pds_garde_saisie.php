...
/**=============================================================================
* SelectMG67()Crée une liste déroulante avec la liste des médecins d'un secteur
* @param	$connexion 		variable de connexion
* @param	$item_select	fonction_ID de l'organisme sélectionné
* @param	$secteur		secteur de garde
* @return Au retour, med_id contient le type_ID du médecin
//=============================================================================*/
...
// mémorisation des variables sous forme de variables cachées
