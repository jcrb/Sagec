...
<div id="div2">
	...
	<fieldset id="field1">
		...
		<p>
			<label for="rem" title="rem">Commentaires:</label>
	...
	<fieldset id="field1">
		...
		<p>
			<label for="ferme">Applicable :</label>
	...
	<fieldset id="field1">
		...
		<label for="adresse" title="">Fichier procédure: </label>
		<input type="file" name="adresse" size="20">
	</fieldset>
