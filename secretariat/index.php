...
<div id="div2">
	...
	<fieldset id="field1">
		...
		<p>
			Liste alphabétique des personnels. Permet d'accéder à la fiche d'un agent pour la modifier et/ou pour fixer une affectation de crise.
		</p>
	</fieldset>
	<fieldset id="field1">
	...
	<fieldset id="field1">
		...
		<p>
			Enregistrement des arrivées (lecture du code barre).
		</p>
	</fieldset>
