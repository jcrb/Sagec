...
//	date de création: 	5/10/2004
//	auteur:			jcb
//	description:		saisie d'une nouveau médicament
//	version:			1.0
//	maj le:			05/10/2004
//
//--------------------------------------------------------------------------------------------------------
...
// rafraichit la fenêtre mère, ce qui permet de mettre à jour la liste
...
if($_GET[med_nom])
{
	...
	//print("maj".$_GET['maj']);
	if($_GET['maj'])// c'est une mise à jour
	{
	...
	else
	{
		...
		$resultat = ExecRequete($requete,$connexion);
		if(mysql_num_rows == 0) // à condition que ce nom n'existe pas déjà
		{
...
else print"<input type=\"submit\" name=\"select_med\" value=\"Ajouter un médicament\">";
