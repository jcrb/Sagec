...
print("<tr>");
	print("<td>matériel: </td>");//-------------------------- médicament
	print("<td>");
...
print("</tr>");
print("</table>");
print("<input type=\"hidden\" name=\"cat\" value=\"2\">"); // il s'agit d'un matériel

if($_GET['lot'])
{
	print("<input type=\"submit\" value=\"modifier\" name=\"ok\">");
	print("    <input type=\"submit\" value=\"dupliquer\" name=\"ok\">");
	print("    <input type=\"submit\" value=\"supprimer\" name=\"ok\" onClick=\"return confirmSubmit('Voulez-vous vraiment détruire ce lot ?');\"><br>");
}
else
