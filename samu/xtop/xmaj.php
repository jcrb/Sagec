...
$backPathToRoot = "../../";
$titre_principal = "Etat d'Occupation des Urgences - Mise à jour";
$sousmenu = "";
...
<form name="xtop" method="post" action="xmaj_enregistre.php">

<div id="div2">
	
	<fieldset id="field1">
		<legend>Lits/places occupés <?php echo dateHeureComplete(time(),$langue="FR");?></legend>
		<p>
		...
		<p>
			<label for="dechoc" title="patients en cours de déchocage">Déchocage:</label>
			<input type="text" name="dechoc" id="dechoc" title="dechoc" value="<? echo $rub[0];?>" size="5" onFocus="_select('dechoc');" onBlur="deselect('dechoc');"/>
		</p>
		<p>
			<label for="uhtcd" title="patients hospitalisés en unité de courte durée">UHTCD:</label>
