...
include_once("top_geoloc_commune.php");
...
<head>
	<meta http-equiv="content-type" content="ype" cont; charset=ISO-8859-15" >
	...
	<link rel="stylesheet" type="text/css" media="screen" href="../../../regulation/formstyle.css" />
   <link rel="stylesheet" type="text/css" media="print" href="../../../regulation/impression.css" />
   <script src = "../../../utilitaires/google/key.js"></script>
    ...
    <script src="../../../regulation/carto_data.php" type="text/javascript"></script>
</head>

<body onload = "init(<?php echo $ville_lat;?>,<?php echo $ville_lng;?>)">
<form>
<?php
	print("<table id=\"lat\" class=\"time\" border=\"1\" cellspacing=\"0\">");
		print("<tr>");
